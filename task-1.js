...
// а вторым параметром cb - функцию обратного вызова(callback). Функция mapArray создает новый массив numbers и 
...
// Просто добавляем индекс
const addIndex = (element, index) => element+index;
// Просто отнимаем индекс
const subIndex = (element, index) => element-index;
  
function mapArray(array, cb) {
  'use strict';
// в new Array добавляем аргумент "длина массива"
